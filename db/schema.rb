...
ActiveRecord::Schema[8.1].define(version: 2026_12_13_090001) do
  ...
  create_table "automated_message_replies", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "automated_message_id", null: false
    t.datetime "created_at", null: false
    t.text "message_body", size: :long, null: false
    t.datetime "read_at"
    t.bigint "recipient_id", null: false
    t.bigint "sender_id", null: false
    t.datetime "updated_at", null: false
    t.index ["automated_message_id", "created_at"], name: "index_automated_message_replies_on_message"
    t.index ["automated_message_id"], name: "index_automated_message_replies_on_automated_message_id"
    t.index ["recipient_id", "read_at"], name: "index_automated_message_replies_unread"
    t.index ["recipient_id"], name: "index_automated_message_replies_on_recipient_id"
    t.index ["sender_id"], name: "index_automated_message_replies_on_sender_id"
  end

  create_table "automated_messages", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.boolean "buyer_replied", default: false, null: false
    t.datetime "created_at", null: false
    t.bigint "message_template_id", null: false
    t.bigint "message_template_variant_id"
    t.bigint "purchase_id", null: false
    t.datetime "read_at"
    t.text "rendered_message", size: :long, null: false
    t.string "rendered_subject"
    t.bigint "sender_id", null: false
    t.datetime "sent_at"
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["buyer_replied"], name: "index_automated_messages_on_buyer_replied"
    t.index ["message_template_id"], name: "index_automated_messages_on_message_template_id"
    t.index ["message_template_variant_id"], name: "index_automated_messages_on_message_template_variant_id"
    t.index ["purchase_id", "message_template_id"], name: "index_automated_messages_uniqueness", unique: true
    t.index ["purchase_id"], name: "index_automated_messages_on_purchase_id"
    t.index ["sender_id", "created_at"], name: "index_automated_messages_on_sender_and_created"
    t.index ["user_id", "read_at"], name: "index_automated_messages_unread"
    t.index ["user_id", "sent_at"], name: "index_automated_messages_on_recipient_and_sent"
    t.index ["user_id"], name: "index_automated_messages_on_user_id"
  end
  ...
  create_table "comments", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["commentable_id", "commentable_type", "post_variant_id"], name: "index_comments_on_commentable_and_post_variant"
    ...
    t.index ["post_variant_id"], name: "index_comments_on_post_variant_id"
  ...
  create_table "fund_cart_funding_lots", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.decimal "affiliate_subunits", precision: 36, default: "0", null: false
    t.json "amount_snapshot"
    t.datetime "available_at"
    t.decimal "available_subunits", precision: 36, default: "0", null: false
    ...
    t.decimal "debt_subunits", precision: 36, default: "0", null: false
    t.string "external_id", null: false
    t.decimal "fee_subunits", precision: 36, default: "0", null: false
    t.bigint "fund_cart_id", null: false
    t.decimal "gross_subunits", precision: 36, default: "0", null: false
    t.string "native_currency"
    t.integer "native_currency_exponent"
    t.decimal "native_gross_subunits", precision: 36
    t.decimal "native_net_subunits", precision: 36
    t.decimal "net_subunits", precision: 36, default: "0", null: false
    t.string "processor", null: false
    t.string "reserve_reference"
    t.decimal "reserved_subunits", precision: 36, default: "0", null: false
    t.datetime "restricted_at"
    t.decimal "reversed_subunits", precision: 36, default: "0", null: false
    ...
    t.decimal "spent_subunits", precision: 36, default: "0", null: false
    t.string "state", default: "pending", null: false
    t.decimal "tax_subunits", precision: 36, default: "0", null: false
    t.datetime "updated_at", null: false
    t.index ["external_id"], name: "index_fund_cart_funding_lots_on_external_id", unique: true
    ...
    t.index ["source_purchase_id"], name: "index_fund_cart_funding_lots_on_source_purchase_id", unique: true
  end

  create_table "fund_cart_items", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "blocking_reason"
    t.datetime "created_at", null: false
    t.string "external_id", null: false
    t.bigint "fund_cart_id", null: false
    ...
    t.string "state", default: "pending", null: false
    t.datetime "updated_at", null: false
    t.index ["external_id"], name: "index_fund_cart_items_on_external_id", unique: true
    t.index ["fund_cart_id"], name: "index_fund_cart_items_on_fund_cart_id"
    t.index ["product_id"], name: "index_fund_cart_items_on_product_id"
    t.index ["purchase_id"], name: "index_fund_cart_items_on_purchase_id"
    t.index ["state"], name: "index_fund_cart_items_on_state"
  end

  create_table "fund_cart_ledger_entries", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "account", null: false
    t.decimal "amount_subunits", precision: 36, null: false
    t.datetime "created_at", null: false
    t.string "currency", null: false
    t.integer "currency_exponent", null: false
    ...
    t.index ["fund_cart_settlement_operation_id", "position"], name: "index_fc_ledger_on_operation_position", unique: true
    t.index ["reversal_of_id"], name: "index_fund_cart_ledger_entries_on_reversal_of_id"
  end

  create_table "fund_cart_settlement_allocations", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.decimal "amount_subunits", precision: 36, null: false
    t.datetime "created_at", null: false
    ...
    t.index ["fund_cart_settlement_id", "fund_cart_funding_lot_id"], name: "index_fc_allocations_on_settlement_lot", unique: true
    t.index ["operation_key"], name: "index_fund_cart_settlement_allocations_on_operation_key", unique: true
  end

  create_table "fund_cart_settlement_operations", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.string "state", default: "pending", null: false
    t.datetime "updated_at", null: false
    t.index ["dispute_id"], name: "index_fund_cart_settlement_operations_on_dispute_id"
    t.index ["fund_cart_funding_lot_id"], name: "index_fc_operations_on_lot"
    t.index ["fund_cart_id"], name: "index_fund_cart_settlement_operations_on_fund_cart_id"
    t.index ["fund_cart_settlement_id"], name: "index_fc_operations_on_settlement"
    t.index ["operation_key"], name: "index_fund_cart_settlement_operations_on_operation_key", unique: true
    t.index ["refund_id"], name: "index_fund_cart_settlement_operations_on_refund_id"
    t.index ["state", "available_at"], name: "index_fc_operations_on_due"
  end

  create_table "fund_cart_settlements", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.string "state", default: "reserved", null: false
    t.datetime "updated_at", null: false
    t.index ["active_item_id"], name: "index_fund_cart_settlements_on_active_item_id", unique: true
    t.index ["external_id"], name: "index_fund_cart_settlements_on_external_id", unique: true
    t.index ["fund_cart_id"], name: "index_fund_cart_settlements_on_fund_cart_id"
    t.index ["fund_cart_item_id"], name: "index_fund_cart_settlements_on_fund_cart_item_id"
    t.index ["operation_key"], name: "index_fund_cart_settlements_on_operation_key", unique: true
    t.index ["purchase_id"], name: "index_fund_cart_settlements_on_purchase_id", unique: true
    t.index ["state"], name: "index_fund_cart_settlements_on_state"
  end

  create_table "fund_carts", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.string "ledger_state", default: "legacy", null: false
    t.bigint "link_id", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["external_id"], name: "index_fund_carts_on_external_id", unique: true
    t.index ["link_id"], name: "index_fund_carts_on_link_id", unique: true
    t.index ["user_id"], name: "index_fund_carts_on_user_id"
  end
  ...
  create_table "message_template_variants", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "message_body", size: :long, null: false
    t.bigint "message_template_id", null: false
    ...
    t.index ["message_template_id", "variant_name"], name: "index_message_template_variants_uniqueness", unique: true
    t.index ["message_template_id"], name: "index_message_template_variants_on_message_template_id"
  end

  create_table "message_templates", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.string "subject"
    t.bigint "templateable_id", null: false
    t.string "templateable_type", null: false
    t.json "trigger_config"
    t.integer "trigger_type", default: 0, null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["templateable_type", "templateable_id", "trigger_type"], name: "index_message_templates_on_templateable_and_trigger"
    t.index ["templateable_type", "templateable_id"], name: "index_message_templates_on_templateable"
    t.index ["trigger_type", "active", "deleted_at"], name: "index_message_templates_on_trigger_active"
    t.index ["user_id", "deleted_at"], name: "index_message_templates_on_user_id_and_deleted_at"
  ...
  create_table "post_variants", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.integer "price_cents"
    t.datetime "updated_at", null: false
    t.index ["installment_id", "is_control"], name: "index_post_variants_on_installment_id_and_is_control"
    t.index ["installment_id"], name: "index_post_variants_on_installment_id"
  end
  ...
  create_table "prices", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["link_id", "currency", "recurrence", "flags"], name: "index_prices_on_link_currency_recurrence_flags_unique", unique: true
  ...
  create_table "product_experiment_assignments", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.datetime "assigned_at", null: false
    t.string "buyer_cookie"
    t.datetime "converted_at"
    t.datetime "created_at", null: false
    t.bigint "product_experiment_id", null: false
    t.bigint "product_experiment_variant_id", null: false
    t.bigint "purchase_id"
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["product_experiment_id", "buyer_cookie"], name: "idx_on_product_experiment_id_buyer_cookie_f57b315074", unique: true
    t.index ["product_experiment_id", "user_id"], name: "idx_on_product_experiment_id_user_id_e760fdda24", unique: true
    t.index ["product_experiment_id"], name: "index_product_experiment_assignments_on_product_experiment_id"
    t.index ["product_experiment_variant_id"], name: "idx_on_product_experiment_variant_id_8d5188c8a6"
    t.index ["purchase_id"], name: "index_product_experiment_assignments_on_purchase_id"
    t.index ["user_id"], name: "index_product_experiment_assignments_on_user_id"
  end

  create_table "product_experiment_variants", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.bigint "product_experiment_id", null: false
    t.json "recurrence_prices"
    t.integer "traffic_count", default: 0, null: false
    t.datetime "updated_at", null: false
    t.integer "weight", default: 1, null: false
    t.index ["product_experiment_id"], name: "index_product_experiment_variants_on_product_experiment_id"
  end

  create_table "product_experiments", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "ended_at"
    t.string "name", null: false
    t.bigint "product_id", null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["product_id", "status"], name: "index_product_experiments_on_product_id_and_status"
    t.index ["product_id"], name: "index_product_experiments_on_product_id"
  end
  ...
  create_table "subscriptions", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["billing_currency"], name: "index_subscriptions_on_billing_currency"
  ...
  create_table "survey_answers", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.text "text_answer"
    t.datetime "updated_at", null: false
    t.index ["survey_question_id", "created_at"], name: "index_survey_answers_on_question_and_date"
    t.index ["survey_question_id"], name: "index_survey_answers_on_survey_question_id"
    t.index ["survey_question_option_id"], name: "index_survey_answers_on_option_id"
  ...
  create_table "survey_question_options", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
  ...
  create_table "survey_questions", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["survey_id", "position"], name: "index_survey_questions_on_survey_and_position"
  ...
  create_table "survey_responses", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.bigint "purchase_id"
    t.string "respondent_cookie"
    t.datetime "started_at"
    t.bigint "subscription_id"
    t.bigint "survey_id", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["purchase_id"], name: "index_survey_responses_on_purchase_id"
    t.index ["subscription_id"], name: "index_survey_responses_on_subscription_id"
    t.index ["survey_id", "completed_at"], name: "index_survey_responses_on_survey_and_completed"
    t.index ["survey_id", "respondent_cookie"], name: "index_survey_responses_on_survey_and_cookie"
    t.index ["survey_id", "started_at", "completed_at"], name: "index_survey_responses_on_survey_progress"
    t.index ["survey_id", "user_id", "completed_at"], name: "index_survey_responses_uniqueness_check"
    t.index ["survey_id", "user_id"], name: "index_survey_responses_on_survey_and_user", unique: true
    t.index ["survey_id"], name: "index_survey_responses_on_survey_id"
    t.index ["user_id", "completed_at"], name: "index_survey_responses_on_user_completion"
  ...
  create_table "surveys", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.string "title", null: false
    t.datetime "updated_at", null: false
    t.index ["base_variant_id", "deleted_at", "closes_at"], name: "index_surveys_on_variant_availability"
    t.index ["base_variant_id"], name: "index_surveys_on_base_variant_id"
    t.index ["deleted_at"], name: "index_surveys_on_deleted_at"
    t.index ["surveyable_type", "surveyable_id", "base_variant_id", "deleted_at"], name: "index_surveys_on_polymorphic_variant"
    t.index ["surveyable_type", "surveyable_id", "deleted_at"], name: "index_surveys_on_surveyable_and_deleted_at"
  ...
  create_table "variant_assignments", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.datetime "assigned_at", null: false
    t.string "buyer_cookie"
    t.datetime "converted_at"
    t.datetime "created_at", null: false
    t.datetime "exposed_at"
    t.bigint "post_variant_id", null: false
    t.bigint "purchase_id"
    t.bigint "subscription_id"
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["buyer_cookie", "post_variant_id"], name: "index_variant_assignments_on_buyer_cookie_and_post_variant", unique: true
    t.index ["converted_at"], name: "index_variant_assignments_on_converted_at"
    t.index ["exposed_at"], name: "index_variant_assignments_on_exposed_at"
    t.index ["post_variant_id", "subscription_id"], name: "index_variant_assignments_on_variant_and_subscription", unique: true
    t.index ["post_variant_id"], name: "index_variant_assignments_on_post_variant_id"
    t.index ["purchase_id"], name: "index_variant_assignments_on_purchase_id"
    t.index ["subscription_id"], name: "index_variant_assignments_on_subscription_id"
    t.index ["user_id", "post_variant_id"], name: "index_variant_assignments_on_user_and_post_variant", unique: true
  end
  ...
  create_table "variant_distribution_rules", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "base_variant_id", null: false
    t.datetime "created_at", null: false
    t.integer "distribution_type", default: 0, null: false
    t.integer "distribution_value"
    t.bigint "post_variant_id", null: false
    t.bigint "product_installment_plan_id"
    t.datetime "updated_at", null: false
    t.index ["base_variant_id"], name: "index_variant_distribution_rules_on_base_variant_id"
    t.index ["post_variant_id", "base_variant_id"], name: "index_variant_distribution_rules_on_variant_and_tier", unique: true
    t.index ["post_variant_id"], name: "index_variant_distribution_rules_on_post_variant_id"
    t.index ["product_installment_plan_id"], name: "idx_on_product_installment_plan_id_9ccccf6799"
  end
  ...
  add_foreign_key "automated_message_replies", "automated_messages"
  add_foreign_key "automated_message_replies", "users", column: "recipient_id"
  add_foreign_key "automated_message_replies", "users", column: "sender_id"
  add_foreign_key "automated_messages", "message_template_variants"
  add_foreign_key "automated_messages", "message_templates"
  add_foreign_key "automated_messages", "purchases"
  add_foreign_key "automated_messages", "users"
  add_foreign_key "automated_messages", "users", column: "sender_id"
  add_foreign_key "comments", "post_variants"
  add_foreign_key "message_template_variants", "message_templates"
  add_foreign_key "message_templates", "users"
  add_foreign_key "post_variants", "installments"
  add_foreign_key "product_experiment_assignments", "product_experiment_variants"
  add_foreign_key "product_experiment_assignments", "product_experiments"
  add_foreign_key "product_experiment_assignments", "purchases"
  add_foreign_key "product_experiment_assignments", "users"
  add_foreign_key "product_experiment_variants", "product_experiments"
  add_foreign_key "product_experiments", "links", column: "product_id"
  ...
  add_foreign_key "survey_responses", "purchases"
  add_foreign_key "survey_responses", "subscriptions"
  add_foreign_key "survey_responses", "surveys"
  add_foreign_key "survey_responses", "users"
  add_foreign_key "surveys", "base_variants"
  add_foreign_key "variant_assignments", "post_variants"
  add_foreign_key "variant_assignments", "purchases"
  add_foreign_key "variant_assignments", "subscriptions"
  add_foreign_key "variant_distribution_rules", "base_variants"
  add_foreign_key "variant_distribution_rules", "post_variants"
  add_foreign_key "variant_distribution_rules", "product_installment_plans"
end
