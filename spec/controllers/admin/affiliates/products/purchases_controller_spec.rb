...
describe Admin::Affiliates::Products::PurchasesController do
  ...
  describe "GET index" do
    ...
    it "returns purchases and pagination for the affiliate" do
      get :index, params: { product_id: product.id, affiliate_external_id: affiliate_user.external_id }, format: :json
    ...
    context "with pagination parameters" do
      ...
      it "accepts per_page and page parameters" do
        get :index, params: { product_id: product.id, affiliate_external_id: affiliate_user.external_id, per_page: 5, page: 1 }, format: :json
      ...
      it "returns the correct page of results" do
        get :index, params: { product_id: product.id, affiliate_external_id: affiliate_user.external_id, per_page: 5, page: 2 }, format: :json
      ...
      it "respects per_page limit" do
        get :index, params: { product_id: product.id, affiliate_external_id: affiliate_user.external_id, per_page: 3, page: 1 }, format: :json
