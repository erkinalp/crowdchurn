...
describe SaveFilesService do
  ...
  describe ".perform" do
    ...
    it "updates files" do
      file_1 = create(:product_file, link: @product, description: "pencil", url: "#{S3_BASE_URL}/attachment/pencil.png")
      file_2 = create(:product_file, link: @product, description: "manual", url: "#{S3_BASE_URL}/attachment/manual.pdf")
      ...
      expect(book_file.url).to eq("#{S3_BASE_URL}/attachment/book.pdf")
      expect(book_file.unique_url_identifier).to eq("#{S3_BASE_URL}/attachment/book.pdf")
    ...
    it "supports `files` param as an array" do
      ...
      file1 = create(:product_file, installment:, url: "#{S3_BASE_URL}/attachment/pencil.png")
      file2 = create(:product_file, installment:, url: "#{S3_BASE_URL}/attachment/manual.pdf")
